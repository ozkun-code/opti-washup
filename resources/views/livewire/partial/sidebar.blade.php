<ul class="menu p-4 w-80 min-h-full bg-base-100 text-base-content border-r-2 border-base-300 space-y-4">
    ...
    <li>
        ...
        <ul>
            ...
            <li>
                <a href="{{ route('transaksi.actions') }}" @class(['active' => Route::is('transaksi.actions')]) wire:navigate>
    ...
    <li>
        ...
        <ul>
            ...
            <li>
                <a href="{{ route('voucher.index') }}" @class(['active' => Route::is('voucher.index')]) wire:navigate>
